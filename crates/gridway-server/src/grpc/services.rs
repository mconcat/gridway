...
pub struct TxService {
    ...
    baseapp: Arc<RwLock<gridway_baseapp::BaseApp>>,
}
    ...
    pub fn new() -> Self {
        Self {
            ...
            baseapp: Arc::new(RwLock::new(
                gridway_baseapp::BaseApp::new("tx-service".to_string())
                    .expect("Failed to create BaseApp"),
            )),
        }
    }

    pub fn with_baseapp(baseapp: Arc<RwLock<gridway_baseapp::BaseApp>>) -> Self {
        Self {
            txs: Arc::new(RwLock::new(HashMap::new())),
            baseapp,
        }
