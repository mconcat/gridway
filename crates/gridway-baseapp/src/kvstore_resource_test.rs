...
mod tests {
    ...
    fn test_kvstore_manager_basic_operations() {
        ...
        // Create a test store
        let store: Arc<Mutex<dyn gridway_store::KVStore>> = Arc::new(Mutex::new(MemStore::new()));
    ...
    fn test_kvstore_manager_multiple_stores() {
        ...
        let store1: Arc<Mutex<dyn gridway_store::KVStore>> = Arc::new(Mutex::new(MemStore::new()));
        let store2: Arc<Mutex<dyn gridway_store::KVStore>> = Arc::new(Mutex::new(MemStore::new()));
